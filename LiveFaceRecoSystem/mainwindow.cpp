...
void MainWindow::init()
{
	...
	connect(cardEditForm, &PersonalCardEditorForm::updateCardList, cardManager, &PersonalCardManager::updateCards, Qt::ConnectionType::DirectConnection);
	connect(cardManager, &PersonalCardManager::personalCardsUpdated, this, &MainWindow::updatePersonalCards, Qt::ConnectionType::DirectConnection);
	...
	connect(connection, &ConnectionToServer::personalCardsSynced, cardManager, &PersonalCardManager::updateCardsFromSync, Qt::ConnectionType::DirectConnection);
	...
	std::thread connectionControlThread = std::thread([&]()
	{
		while(true)
		{
