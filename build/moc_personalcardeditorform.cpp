...
#include "../LiveFaceRecoSystem/personalcardeditorform.h"
...
void PersonalCardEditorForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->updateCardList((*reinterpret_cast< QList<PersonalCard>(*)>(_a[1]))); break;
        ...
        {
            typedef void (PersonalCardEditorForm::*_t)(QList<PersonalCard> );
...
// SIGNAL 0
void PersonalCardEditorForm::updateCardList(QList<PersonalCard> _t1)
{
